...
def main():
   ...
   # with open("design.css") as source_des:
    ...
    #st.markdown("---")
   # st.markdown(f'[chatbot link](https://huggingface.co/spaces/timefullytrue/RAG_based_chat_on_patents_data_with_Mistral)', unsafe_allow_html=True)
    st.write("")
    st.subheader("Explore Our Patent Chatbot")
    st.write("Curious about patents and intellectual property? Click the button below to try out our AI-powered chatbot that can discuss these topics with you. The chatbot uses advanced language models to retrieve relevant information from a database of patent data, allowing you to engage in informative and interesting conversations about patents and related subjects")

    st.link_button("Click here for ChatBot", "https://huggingface.co/spaces/timefullytrue/RAG_based_chat_on_patents_data_with_Mistral")
    st.write("")
    st.write("")
